...
public static void main(String[] args) {
  SwingUtilities.invokeLater(() -> {
      TaskPaneExample1 taskPaneExample1 = new TaskPaneExample1();
  });
}
...
// images
//XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
 NetworkConnected("/images/searchmonkey-300x300.png"),
 NetworkDisconnected("/images/searchmonkey-300x300.png"),
 Quit("/images/searchmonkey-300x300.png");
//XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
// data
//XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
...
BufferedImage getImage() {
    //new javax.swing.ImageIcon(getClass().getResource("/images/calendar.png"))
 try {
 return ImageIO.read(getClass().getResource(imagefilename));
 }
 catch (IOException e) {
 return null;
 }
...
private void changeUIdefaults() {
  ...
  */
  ...
  UIManager.put("TaskPaneContainer.background", Color.GRAY); // Colors.LightGray.color(0.5f));
  // setting taskpane defaults
  UIManager.put("TaskPane.font", new FontUIResource(new Font("Verdana", Font.BOLD, 16)));
  UIManager.put("TaskPane.titleBackgroundGradientStart", Color.WHITE); // Colors.White.color());
  UIManager.put("TaskPane.titleBackgroundGradientEnd", Color.LIGHT_GRAY); // Colors.LightBlue.color());
}
...
public Painter getPainter() {
  int width = 100;
  int height = 100;
  Color color1 = Color.WHITE; // Colors.White.color(0.5f);
  Color color2 = Color.GRAY; // Colors.Gray.color(0.5f);
