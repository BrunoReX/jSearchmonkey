...
AppId={{0987914F-D192-46B5-A06A-32821829F4AE}
...
OutputBaseFilename={#MyAppName}_static_v{#MyAppVersion}
OutputDir=.
Compression=lzma
...
Source: "etc\Java\x64\jre1.8.0_161\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs;  Check: Is64BitInstallMode
Source: "etc\Java\i586\jre1.8.0_161\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs; Check: not Is64BitInstallMode
;
